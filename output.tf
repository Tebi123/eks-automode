...
output "mountpoint_s3_csi_driver_role_arn" {
  description = "ARN of the Mountpoint S3 CSI driver IAM role"
  value       = module.mountpoint_s3_csi_driver_irsa.iam_role_arn
}
